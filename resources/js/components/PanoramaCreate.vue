<template>
    <div class="row no-gutters">
        ...
        <div class="col-md border p-3">
            ...
            <fieldset>
                <legend> Data Panorama Baru</legend>
                ...
                <form @submit.prevent="onFormSubmit">
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            placeholder="Nama"
                            :class="{
                                'is-invalid': get(error_data, 'errors.nama[0]', false)
                            }"
                            id="nama"
                            type="text"
                        >
                        <span class="invalid-feedback">
                            {{ get(error_data, 'errors.nama[0]', '') }}
                        </span>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea
                            v-model.number="deskripsi"
                            class="form-control"
                            placeholder="Deskripsi"
                            :class="{
                                'is-invalid': get(error_data, 'errors.deskripsi[0]', false)
                            }"
                            id="deskripsi"
                            type="text"
                        ></textarea>
                        <span class="invalid-feedback">
                            {{ get(error_data, 'errors.deskripsi[0]', '') }}
                        </span>
                    </div>
